...
With one caveat: do you want to be OSCE3? Then you do it. I don't particularly care about Windows x86 binary exploitation, but I want the title. More and more I catch myself wondering *why* I want it so much, but we're already 2/3 of the way in, so we power through. It's been _fun_. 
